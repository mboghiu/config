...
let s:SkyBlue		= ['#729fcf', '#3465a4', '#204a87', '#5A75AB']
let s:Plum			= ['#ad7fa8', '#75507b', '#5c3566']
let s:Chocolate		= ['#e9b96e', '#c17d11', '#8f5902']
let s:ScarletRed	= ['#ef2929', '#cc0000', '#a40000', '#7B3436']
let s:Aluminium		= ['#eeeeec', '#d3d7cf', '#babdb6',
					\'#888a85', '#555753', '#2e3436']
let s:Green         = ['#0C831A', '#2E6D36']
let s:Black         = ['#000000']
...
execute "hi Special      guifg=" . s:SkyBlue[0]
execute "hi Statement    guifg=" . s:Aluminium[3]
execute "hi String       gui=italic guifg=" . s:SkyBlue[0]
execute "hi Title        guifg=" . s:Aluminium[0]
execute "hi Todo         gui=bold guisp=NONE guibg=" . s:Green[0]
			\. " guifg=" . s:Aluminium[0]
...
execute "hi LineNr       guibg=" . s:Aluminium[5] . " guifg=" . s:Aluminium[3]
...
execute "hi Visual       guibg=" . s:Green[0] . " guifg=" . s:Aluminium[1]
...
execute "hi DiffChange   guibg=" . s:SkyBlue[1]
execute "hi DiffText     guibg=" . s:SkyBlue[1]
execute "hi DiffDelete   guibg=" . s:Green[1] . " guifg=" . s:Aluminium[5]
execute "hi DiffAdd      guibg=" . s:ScarletRed[3]
execute ""
" }}}
